<template>
    ...
    <div class="row">
        ...
        <div class="pull-right"> <b-button  variant="success" @click="_create()">+ Découpage Deux</b-button></div>
            ...
            <div class="single-table">
                <div class="table-responsive">
                    <table class="table table-striped  table-hover text-center">
                        ...
                        <tbody>
                        <tr v-for="decoupagedeux in items.data">
                            <td>{{ decoupagedeux.id }}</td>
                            <td>{{ decoupagedeux.nom }}</td>
                            <td>{{ decoupagedeux.libelle }}</td>
                            <td>{{decoupagedeux.decoupageun}}</td>
                            <td>{{ decoupagedeux.created_at}}</td>
                            <td class="text-right">
                                <button type="button" rel="tooltip" class="btn btn-info btn-icon btn-sm "
                                        title="detail" @click="show(decoupagedeux)">
                                    <i class="fa fa-eye"></i>
                                </button>
                                <button type="button" rel="tooltip" class="btn btn-success btn-icon btn-sm "
                                        title="mise à jours" @click="edit(decoupagedeux)">
                                    <i class="fa fa-edit"></i>
                                </button>
                                <button type="button" rel="tooltip" class="btn btn-danger btn-icon btn-sm "
                                        title="suppression" @click="deleteModal(decoupagedeux)">
