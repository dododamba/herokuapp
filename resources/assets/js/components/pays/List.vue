<template>
    ...
    <div class="row">
        ...
        <div class="pull-right"> <b-button  variant="success" @click="_create()">+ Pays</b-button></div>
...
<script>
    ...
    export default {
        ...
        methods: {
            _fetch(url) {
                ...
                axios.get(url)
                    .then(function (response) {
                        ...
                        _self.items = response.data.content.pays;
            ...
            _create(){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        this._fetch('/api/pays?page=' + _self.current_page_);
                        Swal.fire(
                            'Succès !',
            ...
            update(item) {
                var _self = this;
                var _pays = _self.pays;
                _pays = item;

                axios.post('/api/update-pays', _pays)
                    .then(function (response) {
                ...
                this.$refs['edit'].hide();
                this._fetch('/api/pays?page=' + this.current_page_);
            }
